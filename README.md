...
###
<p>For the Solver itself I used Scipy.linprog library, the documentations for it is availible <a href="https://docs.scipy.org/doc/scipy/reference/optimize.linprog-highs.html">here.<a/><p/>
